...
?>
<footer class="footer">
    <div class="background_image" style="background-image:url(images/Cover/Footer.jpg);"></div>
    <div class="container">
        <div class="row">
            <div class="col">
    ...
    <div class="col text-center reserve"  >
...
<?php
    if(isset($_POST['sug_submit'])){
        ...
        if($errmsg == "success"){
            header("location:success.php?msg=".md5(suggest));
        }
    }
?>